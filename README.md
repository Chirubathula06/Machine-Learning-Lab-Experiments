...
This repository contains implementations of various Machine Learning algorithms as part of academic lab experiments.

Each experiment includes:
- Basic implementation (without libraries)
- Real-world dataset implementation
- Library-based implementation
- Performance analysis (for selected experiments)
...
- **Basic Implementation** → Without using libraries  
- **Real-world Implementation** → Applied on datasets  
- **Library-based Implementation** → Using ML libraries  
- **Experimentation** → Performance comparison (10, 100, 300 records)  
...
✔ Compared with library implementations  
✔ Performed dataset-based experimentation  
